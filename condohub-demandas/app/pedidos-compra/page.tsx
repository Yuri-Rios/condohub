...
type Pedido = { id:number; ocorrencia_id:number|null; item:string; quantidade:number; unidade:string; justificativa:string; valor_estimado:number|null; status:"create"|"ongoing"|"done"; solicitante_nome:string; criado_em:string; pode_gerenciar:boolean; pode_editar:boolean; pode_excluir:boolean; historico:Historico[] };
